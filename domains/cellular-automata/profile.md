...
It is intended for projects such as `cellauto-lab`, where Claude Code is used as a governed implementation partner to build reproducible simulations, extract metrics, generate visual artifacts, and support AI-assisted exploration of cellular automata rule spaces.
