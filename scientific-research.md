...
This domain is especially relevant for projects where Claude Code or another LLM helps explore a problem space, such as `syntran-ca-lab`.
...
Task:
Design a reproducible notebook-first research architecture for SYNTRAN CA-Lab.
...
Task:
Write an explanation document for the research method used in SYNTRAN CA-Lab.
...
For the first CA-Lab iteration, keep the AI role modest:
